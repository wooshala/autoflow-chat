// Phase 1F.7 — pure validation for the customer-service translate API. DOM/OpenAI-free
// so it is unit-testable and shared between the route and clients. Lang codes are the
// BCP-47 set from translationLangs (CustomerLang); kept inline here to stay import-free
// for Node's type-stripping test runner.
